  ...
  return (
    <div className='max-w-screen-xl py-16 px-4 grid lg:grid-cols-12 gap-8 mx-auto'>
        <div className="md:col-span-8 bg-white">
            <img src={activity.imageUrls[0]} alt={activity.title} width={770} height={430} className="w-full rounded-sm mb-8"/>
            <h1 className="text-5xl font-semibold text-gray-900 mb-4">{activity.title}</h1>
